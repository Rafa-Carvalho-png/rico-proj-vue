<template>
    <nav class="bg-white border-b border-gray-200" :class="{ 'mr-[250px]': isAuthenticated }">
        <div class="relative container mx-auto px-4 py-2 flex justify-between items-center">
            ...
            <div :class="{'absolute top-[44px] right-0': isMenuOpen, 'hidden': !isMenuOpen}" class="w-full max-w-24 lg:flex lg:items-center lg:w-auto">
